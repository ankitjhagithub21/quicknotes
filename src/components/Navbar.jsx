  ...
  return (
    <nav className='relative'>
      <div className="container mx-auto flex items-center justify-between px-3 py-5">
        ...
        <div className={`fixed md:hidden block ${isOpen ? 'translate-x-0':'translate-x-full'}  transition duration-300 ease-in-out h-screen top-0 flex flex-col  p-5 gap-5 bg-black z-50  right-0`}>
